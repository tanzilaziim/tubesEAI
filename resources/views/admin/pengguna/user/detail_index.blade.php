            ...
            <div class="card">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-custom">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('administrator/pengguna/user/') }}">User</a></li>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" value="{{ $user->tgl_lahir }}" readonly>
                        </div>
                    </div>
...
<script>
    function buttonBack() {
        location.replace("{{ url('administrator/pengguna/user') }}");
    }
</script>
@endsection
