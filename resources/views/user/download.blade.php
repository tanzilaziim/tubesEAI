...
<html lang="zxx">
    ...
    <div class="bg-download">
        <div class="content">
            <h1>Ayo Mulai Investasi Internet</h1>
            <p>Download Vestnet Sekarang</p>
            <div class="download-buttons">
                <a href="#"><img src="{{ asset('assets/img/icon/playstore.png')}}" class="img-small" alt="google play"></a>
                <a href="#"><img src="{{ asset('assets/img/icon/appstore.png')}}" class="img-small" alt="app store"></a>
            </div>
            <div class="note">
                <p>*Investasi hanya bisa dilakukan pada aplikasi vestnet</p>
            </div>
        </div>
    </div>
        <!-- Start Footer Area -->
